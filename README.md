...
- **타일 스타일 개선**
  - D-Day가 지난 타일의 배경과 텍스트를 회색으로 변경하여 시각적 구분을 명확히 했습니다.
  - 긴 제목이 3줄을 초과할 경우 말줄임표(...)로 표시되도록 수정했습니다.

- **UI 편의성 개선**
  - 미니맵과 줌 버튼이 타일을 가리는 문제를 해결하기 위해, 헤더에 UI 표시/숨김 토글 버튼을 추가했습니다.

- **기능 오류 수정**
  - '좋아요' 버튼 클릭 시 간헐적으로 발생하던 런타임 오류를 수정했습니다.